  ...
  <div class="container">
    ...
    <div v-else class="products">
      ...
      <div v-if="products" class="products--layout">
        <div v-for="product in prods" :key="product.id" class="products--item">
          ...
          <div class="products--item-info">
            ...
            <div class="products--item-bottom">
              ...
              <div v-show="product.quantity" class="products--item-quant">
                ...
                <span class="products--item-quantity">{{
                  product.quantity
                }}</span>
                <button
...
export default {
  ...
  computed: {
    ...
    prods() {
      return this.products.map((item) => {
        const cartInfo = this.productsInCart.filter(
  ...
  methods: {
    ...
    async updateProducts() {
      ...
      this.categoryName = this.$store.getters.getCategoryInfoByUrl(
        this.url
      ).name
      const productList =
        (await this.$store.dispatch('fetchProducts', this.url)) || {}
