  ...
  <div id="nav" class="nav">
    <div class="nav--container">
      <div class="nav--left">
        ...
        <button
          class="nav--menu-btn"
          :class="{ 'nav--menu-btn__active': isMenuOpen }"
      ...
      <div class="nav--right">
        ...
        <button class="btn nav--btn nav--btn__cart" @click="isCartOpen = true">
          ...
          >
            ...
            />
            <path
              d="M25.3333 17.6667V11C25.3333 9.5855 24.7714 8.22895 23.7712 7.22875C22.771 6.22856 21.4144 5.66666 20 5.66666C18.5855 5.66666 17.2289 6.22856 16.2287 7.22875C15.2285 8.22895 14.6666 9.5855 14.6666 11V17.6667"
              stroke="#333333"
              stroke-width="2.66667"
              stroke-linecap="round"
              stroke-linejoin="round"
          ...
          <span v-show="cartCounter" class="nav--cart-count">{{
            cartCounter
          }}</span>
        </button>
      </div>
    ...
    <MenuModal
      v-show="isMenuOpen"
      :open="isMenuOpen"
      @close-modal="isMenuOpen = false"
    />
    <Cart
      v-show="isCartOpen"
      :open="isCartOpen"
      @cart-close="isCartOpen = false"
      @cart-updated="updateCartCounter"
    />
  </div>
</template>
